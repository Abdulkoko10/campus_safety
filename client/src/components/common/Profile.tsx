...
import { ProfileProps, ReportProps } from 'interfaces/common';
...
const Profile = ({ type, name, avatar, email, phoneNumber, reports }: ProfileProps) => (
  <Box>
          ...
          <Box flex={1} display="flex" flexDirection={{ xs: 'column', md: 'row' }} gap="20px">
            ...
            <Box flex={1} display="flex" flexDirection="column" justifyContent="space-between" gap="30px">
              <Stack direction="column">
                ...
                <Typography fontSize={16} color="#808191">Student</Typography>
              </Stack>
                ...
                <Stack direction="row" flexWrap="wrap" gap="20px" pb={4}>
                  <Stack flex={1} gap="15px">
                    ...
                    <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                      ...
                      <Typography fontSize={14} color="#11142D" noWrap>{phoneNumber}</Typography>
                    </Box>
                  </Stack>
    ...
    <Box
      ...
      bgcolor="#FCFCFC"
    >
      <Typography fontSize={18} fontWeight={600} color="#11142D">{type} Reports</Typography>
      ...
      >
        {reports?.map((report: ReportProps) => (
          <ReportCard key={report._id} id={report._id}
            title={report.title}
